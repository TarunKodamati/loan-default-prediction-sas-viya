...
| home_ownership     | Home ownership status                            | Input  | Nominal  |
...
| loan_status        | Status of the loan                               | Target | Nominal  |
| purpose            | Purpose of loan                                  | Input  | Nominal  |
| addr_state         | Borrower state                                   | Input  | Nominal  |
